...
function PhilosophyMobile() {
  return (
    ...
    <Swiper
      ...
      className="mySwiper"
    >
      <SwiperSlide className="swiper-slide translate-y-[20%] opacity-0 z-20 h-full md:space-y-sm space-y-[8px] bg-[#F8FCFF] rounded-[20px] md:p-md p-sm liAnim1">
      ...
      <SwiperSlide className="swiper-slide translate-y-[20%] opacity-0 z-20 h-full md:space-y-sm space-y-[8px] bg-[#F8FCFF] rounded-[20px] md:p-md p-sm liAnim2">
        <figure className="w-fit rounded-full">
      ...
      <SwiperSlide className=" swiper-slide translate-y-[20%] opacity-0 z-20 h-full md:space-y-sm space-y-[8px] bg-[#F8FCFF] rounded-[20px] md:p-md p-sm liAnim3">
        <figure className="w-fit rounded-full">
